...
After that you should transfer ownership of those contracts to the `prods.evm` linked EVM account for configuration of the `lockDuration` and `maxDeposits` variables.
